...
class MainClass {
  ...
  static string E_MISSING_OPERAND =
    "sleep: missing operand\n"+
    "Try 'sleep --help' for more information.\n";

  static string E_INVALID_TIME_INTERVAL =
    "sleep: invalid time interval ‘${interval}’\n"+
    "Try 'sleep --help' for more information.\n";

  static string E_UNKNOWN_OPTION =
    "sleep: unknown option -- ${option}\n"+
    "Try 'sleep --help' for more information.\n";

  static Regex REGEX = new Regex(@"^[\d\.\+\-eE]+");
  ...
  public static void Main (string[] args) {
    ...
    string unit = operand.Substring(match.Length).ToLower();
